      ...
      <el-container>
        <el-aside width="250px">
          <div class="components-list">
            <template v-if="basicFields.length">
              <div class="widget-cate">Basic Component</div>
              <draggable
                tag="ul"
            ...
            <template v-if="advanceFields.length">
              <div class="widget-cate">Advance Component</div>
              <draggable
                tag="ul"
        ...
        >
          ...
          <template slot="action">
            <el-button type="info" @click="handleCopyCode">copyCode</el-button>
            <el-button type="primary" @click="handleTest">getData</el-button>
        ...
        >
          <el-alert
            type="info"
            title="There is the format of JSON below，you can overwrite it with you own JSON code"
          ></el-alert>
...
export default {
  ...
  methods: {
    ...
    copyJsonDataHandler() {
      ...
      if (cpSuccess) {
        this.$message.success("Copy Successed");
      }
    },
    handleUpload() {
